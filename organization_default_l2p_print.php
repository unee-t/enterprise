...
require_once("include/organization_default_l2p_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Organization Default L2P" );
