...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Assign_Buildings_to_User_print";
...
$page_layouts["Assign_Buildings_to_User_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Assign Buildings to User" );
