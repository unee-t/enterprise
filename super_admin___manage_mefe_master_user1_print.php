...
require_once("include/super_admin___manage_mefe_master_user1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Super Admin - Manage MEFE Master User" );
