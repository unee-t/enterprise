...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "external_property_groups_areas_print";
...
$page_layouts["external_property_groups_areas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "external_property_groups_areas" );
