...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "List_of_Countries_print";
...
$page_layouts["List_of_Countries_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "List of Countries" );
