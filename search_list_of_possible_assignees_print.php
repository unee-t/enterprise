...
require_once("include/search_list_of_possible_assignees_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Search list of possible assignees" );
