...
require_once("include/Assign_Areas_to_User_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Assign_Areas_to_User_print";
...
$page_layouts["Assign_Areas_to_User_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Assign Areas to User" );
