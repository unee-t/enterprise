...
require_once("include/property_groups_countries_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "property_groups_countries_edit";
...
$page_layouts["property_groups_countries_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "property_groups_countries_list";
...
$page_layouts["property_groups_countries_list"] = $layout;
...
$keys = array();
$keys["id_country"] = postvalue("editid1");
$keys["country_code"] = postvalue("editid2");
