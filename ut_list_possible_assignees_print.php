...
require_once("include/ut_list_possible_assignees_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ut_list_possible_assignees" );
