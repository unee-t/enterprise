...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "property_groups_areas_print";
...
$page_layouts["property_groups_areas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "property_groups_areas" );
