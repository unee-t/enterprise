...
require_once("include/uneet_enterprise_uggroups_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "uneet_enterprise_uggroups" );
