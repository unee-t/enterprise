...
require_once("include/Export_and_Import_Units_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Export_and_Import_Units_print";
...
$page_layouts["Export_and_Import_Units_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Export and Import Units" );
