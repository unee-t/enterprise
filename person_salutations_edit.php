...
require_once("include/person_salutations_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "person_salutations_edit";
...
$page_layouts["person_salutations_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "person_salutations_list";
...
$page_layouts["person_salutations_list"] = $layout;
...
$keys = array();
$keys["id_salutation"] = postvalue("editid1");
$keys["salutation"] = postvalue("editid2");
