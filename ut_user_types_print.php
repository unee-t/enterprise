...
require_once("include/ut_user_types_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ut_user_types_print";
...
$page_layouts["ut_user_types_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ut_user_types" );
