...
require_once("include/super_admin___default_sot_for_unee_t_objects_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Super Admin - Default sot for Unee-T objects" );
