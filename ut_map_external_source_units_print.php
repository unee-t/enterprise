...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ut_map_external_source_units_print";
...
$page_layouts["ut_map_external_source_units_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ut_map_external_source_units" );
