 ...
 */
 ...
 class eventclass_Manage_Rooms  extends eventsBase
{
...
function BeforeAdd(&$values, &$message, $inline, &$pageObject)
{
	...
	# We  record the id of the system that is the source of truth for this organization
		...
		#  Make sure we have an external id. If empty, we use the name of the room.
			...
			# We replace the empty value with the default
				...
				$values["external_id"] = $values['room_designation'];
			}
...
function BeforeInsert(&$rawvalues, &$values, &$pageObject, &$message)
{
	...
	// What is the creation method
		...
		$values['creation_method'] = 'Manage_Rooms_Import_Page';
	...
	// What is the creation method
		...
		$values['update_method'] = 'Manage_Rooms_Import_Page';
