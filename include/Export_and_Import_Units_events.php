 ...
 */
 ...
 class eventclass_Export_and_Import_Units  extends eventsBase
{
...
function BeforeInsert(&$rawvalues, &$values, &$pageObject, &$message)
{
	...
	// What is the creation method
		...
		$values['creation_method'] = 'Export_and_Import_Units_Import_Page';
	...
	// What is the creation method
		...
		$values['update_method'] = 'Export_and_Import_Units_Import_Page';
