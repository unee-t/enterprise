...
$tdataadmin_users[".searchableFields"] = array();
	...
	$tdataadmin_users[".OriginalTable"] = "uneet_enterprise_users";
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_users["English"]["organization_id"] = "Organization Id";
	$fieldToolTipsadmin_users["English"]["organization_id"] = "";
	$placeHoldersadmin_users["English"]["organization_id"] = "";
...
$tdataadmin_users[".googleLikeFields"][] = "organization_id";
...
$tdataadmin_users[".sqlHead"] = "SELECT ID,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	organization_id";
$tdataadmin_users[".sqlFrom"] = "FROM uneet_enterprise_users";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "uneet_enterprise_users";
	$fdata["Label"] = GetFieldLabel("admin_users","organization_id");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataadmin_users["organization_id"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "organization_id";
