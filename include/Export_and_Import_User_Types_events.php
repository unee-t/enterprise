 ...
 */
 ...
 class eventclass_Export_and_Import_User_Types  extends eventsBase
{
...
function BeforeInsert(&$rawvalues, &$values, &$pageObject, &$message)
{
	...
	// What is the creation method
		...
		$values['creation_method'] = 'Export_and_Import_User_Types_Import_page';
	...
	// What is the creation method
		...
		$values['update_method'] = 'Export_and_Import_User_Types_Import_page';
