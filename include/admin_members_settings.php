...
$tdataadmin_members[".searchableFields"] = array();
	...
	$tdataadmin_members[".OriginalTable"] = "uneet_enterprise_users";
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_members["English"]["organization_id"] = "Organization Id";
	$fieldToolTipsadmin_members["English"]["organization_id"] = "";
	$placeHoldersadmin_members["English"]["organization_id"] = "";
...
$tdataadmin_members[".strOriginalTableName"] = "uneet_enterprise_users";
...
$tdataadmin_members[".googleLikeFields"][] = "organization_id";
...
$tdataadmin_members[".sqlHead"] = "SELECT ID,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	organization_id";
$tdataadmin_members[".sqlFrom"] = "FROM uneet_enterprise_users";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "uneet_enterprise_users";
	$fdata["Label"] = GetFieldLabel("admin_members","organization_id");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataadmin_members["organization_id"] = $fdata;
		$tdataadmin_members[".searchableFields"][] = "organization_id";
