 ...
 */
 ...
 class eventclass_super_admin___default_sot_for_unee_t_objects  extends eventsBase
{
...
function BeforeAdd(&$values, &$message, $inline, &$pageObject)
{
	...
	// What is the creation method
		...
		$values['creation_method'] = 'Super Admin - Default sot for Unee-T objects';
...
function BeforeEdit(&$values, $where, &$oldvalues, &$keys, &$message, $inline, &$pageObject)
{
  ...
  // This should be an INT (default is 1 (unknown)
	...
	// What is the creation method
		...
		$values['update_method'] = 'Super Admin - Default sot for Unee-T objects';
