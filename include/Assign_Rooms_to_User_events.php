 ...
 */
 ...
 class eventclass_Assign_Rooms_to_User  extends eventsBase
{
...
# We check if we have already created this record:
		...
		# We query the table 
			...
			$strSQLExists = "select * 
							...
							where (`unee_t_level_3_id` = '" . $values['unee_t_level_3_id'] . "'
...
function BeforeInsert(&$rawvalues, &$values, &$pageObject, &$message)
{
	...
	// What is the creation method
		...
		$values['creation_method'] = 'Assign_Rooms_to_Users_Import_Page';
	...
	// What is the creation method
		...
		$values['update_method'] = 'Assign_Rooms_to_Users_Import_Page';
