 ...
 */
 ...
 class eventclass_super_admin___manage_mefe_master_user1  extends eventsBase
{
...
function BeforeEdit(&$values, $where, &$oldvalues, &$keys, &$message, $inline, &$pageObject)
{
	...
	// What is the creation method
		...
		$values['update_method'] = 'Super Admin - Manage MEFE Master User';
