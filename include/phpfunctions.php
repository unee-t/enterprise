...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
		if($table=="Manage Unee-T Users" && $field=="person_status_id" && $ptype=="edit")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unee-T Users" && $field=="person_status_id" && $ptype=="add")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unee-T Users" && $field=="person_status_id" && $ptype=="search")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		...
		if($table=="Manage Unee-T Users" && $field=="salutation_id")
	{
		...
		if($table=="Manage Unee-T Users" && $field=="country_code" && $ptype=="edit")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unee-T Users" && $field=="country_code" && $ptype=="add")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unee-T Users" && $field=="country_code" && $ptype=="search")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="admin_users" && $field=="organization_id")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unit Names" && $field=="unee_t_unit_type")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage Unit Names" && $field=="external_property_type_id" && $ptype=="search")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage User Types" && $field=="ut_user_role_type_id" && $ptype=="edit")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage User Types" && $field=="ut_user_role_type_id" && $ptype=="add")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
		if($table=="Manage User Types" && $field=="ut_user_role_type_id" && $ptype=="search")
	{
		$strWhere = " is_obsolete = 0 ";
		return $strWhere;
	}
