...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Export_and_Import_Rooms_print";
...
$page_layouts["Export_and_Import_Rooms_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Export and Import Rooms" );
