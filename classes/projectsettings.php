...
//		return $this->getTableData(".filterFields");
	...
	{
		return new ProjectSettings("uneet_enterprise_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Manage Unee-T Users" ] = array( "url" => "Manage_Unee_T_Users", "type" => 1 );
	$projectEntitiesReverse[ "Manage_Unee_T_Users" ] = "Manage Unee-T Users";
	$projectEntities[ "admin_rights" ] = array( "url" => "admin_rights", "type" => 1 );
	$projectEntitiesReverse[ "admin_rights" ] = "admin_rights";
	$projectEntities[ "uneet_enterprise_users" ] = array( "url" => "uneet_enterprise_users", "type" => 0 );
	$projectEntitiesReverse[ "uneet_enterprise_users" ] = "uneet_enterprise_users";
	...
	$projectEntities[ "Manage Users - Unee-T Enterprise UI" ] = array( "url" => "Manage_Users___Unee_T_Enterprise_UI", "type" => 1 );
	$projectEntitiesReverse[ "Manage_Users___Unee_T_Enterprise_UI" ] = "Manage Users - Unee-T Enterprise UI";
	$projectEntities[ "uneet_enterprise_organizations" ] = array( "url" => "uneet_enterprise_organizations", "type" => 0 );
	$projectEntitiesReverse[ "uneet_enterprise_organizations" ] = "uneet_enterprise_organizations";
	$projectEntities[ "ut_user_types" ] = array( "url" => "ut_user_types", "type" => 0 );
	$projectEntitiesReverse[ "ut_user_types" ] = "ut_user_types";
	$projectEntities[ "person_statuses" ] = array( "url" => "person_statuses", "type" => 0 );
	$projectEntitiesReverse[ "person_statuses" ] = "person_statuses";
	$projectEntities[ "person_salutations" ] = array( "url" => "person_salutations", "type" => 0 );
	$projectEntitiesReverse[ "person_salutations" ] = "person_salutations";
	$projectEntities[ "property_groups_countries" ] = array( "url" => "property_groups_countries", "type" => 0 );
	$projectEntitiesReverse[ "property_groups_countries" ] = "property_groups_countries";
	$projectEntities[ "Manage Unit Names" ] = array( "url" => "Manage_Unit_Names", "type" => 1 );
	$projectEntitiesReverse[ "Manage_Unit_Names" ] = "Manage Unit Names";
	$projectEntities[ "ut_unit_types" ] = array( "url" => "ut_unit_types", "type" => 0 );
	$projectEntitiesReverse[ "ut_unit_types" ] = "ut_unit_types";
	$projectEntities[ "ut_property_types" ] = array( "url" => "ut_property_types", "type" => 0 );
	$projectEntitiesReverse[ "ut_property_types" ] = "ut_property_types";
	$projectEntities[ "Manage User Types" ] = array( "url" => "Manage_User_Types", "type" => 1 );
	$projectEntitiesReverse[ "Manage_User_Types" ] = "Manage User Types";
	$projectEntities[ "ut_user_role_types" ] = array( "url" => "ut_user_role_types", "type" => 0 );
	$projectEntitiesReverse[ "ut_user_role_types" ] = "ut_user_role_types";
	$projectEntities[ "Manage User Default Visibility" ] = array( "url" => "Manage_User_Default_Visibility", "type" => 1 );
