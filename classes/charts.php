...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("external_persons" == $this->chrt_array['tables'][0])
			return true;
		if("uneet_enterprise_ugrights" == $this->chrt_array['tables'][0])
			return true;
		...
		if("ut_user_types" == $this->chrt_array['tables'][0])
			return true;
		if("person_statuses" == $this->chrt_array['tables'][0])
			return true;
		if("person_salutations" == $this->chrt_array['tables'][0])
			return true;
		if("property_groups_countries" == $this->chrt_array['tables'][0])
			return true;
		if("ut_map_external_source_units" == $this->chrt_array['tables'][0])
			return true;
		if("ut_unit_types" == $this->chrt_array['tables'][0])
			return true;
		if("ut_property_types" == $this->chrt_array['tables'][0])
			return true;
		if("ut_user_types" == $this->chrt_array['tables'][0])
			return true;
		if("ut_user_role_types" == $this->chrt_array['tables'][0])
			return true;
		if("ut_user_types" == $this->chrt_array['tables'][0])
			return true;
		if("ut_user_types" == $this->chrt_array['tables'][0])
