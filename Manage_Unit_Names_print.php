...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Manage_Unit_Names_print";
...
$page_layouts["Manage_Unit_Names_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Manage Unit Names" );
