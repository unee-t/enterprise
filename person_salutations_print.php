...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "person_salutations_print";
...
$page_layouts["person_salutations_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "person_salutations" );
