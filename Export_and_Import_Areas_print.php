...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Export_and_Import_Areas_print";
...
$page_layouts["Export_and_Import_Areas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Export and Import Areas" );
