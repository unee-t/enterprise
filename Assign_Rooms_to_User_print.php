...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Assign_Rooms_to_User_print";
...
$page_layouts["Assign_Rooms_to_User_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Assign Rooms to User" );
