...
require_once("include/superadmin___manage_unte_admins_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "SuperAdmin - manage UNTE admins" );
