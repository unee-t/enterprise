...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;bz-db-local-dev-env.c5eg6u2xj9yy.ap-southeast-1.rds.amazonaws.com;unee_t_root;6hdu9hzZq4Yi7g9YAcUN;3306;unee_t_enterprise_v1.23.0;;1"; //currently unused
		...
		$data["connInfo"][4] = "unee_t_enterprise_v1.23.0";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=bz-db-local-dev-env.c5eg6u2xj9yy.ap-southeast-1.rds.amazonaws.com;Uid=unee_t_root;Pwd=6hdu9hzZq4Yi7g9YAcUN;Port=3306;Database=unee_t_enterprise_v1.23.0;OPTION=3";
		// encription set
