...
require_once("include/Manage_User_Types_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Manage_User_Types_print";
...
$page_layouts["Manage_User_Types_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Manage User Types" );
