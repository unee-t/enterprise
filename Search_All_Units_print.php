...
require_once("include/Search_All_Units_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "Search_All_Units_print";
...
$page_layouts["Search_All_Units_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Search All Units" );
