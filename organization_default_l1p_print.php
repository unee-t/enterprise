...
require_once("include/organization_default_l1p_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Organization Default L1P" );
