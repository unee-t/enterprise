...
require_once("include/uneet_enterprise_users_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "uneet_enterprise_users_print";
...
$page_layouts["uneet_enterprise_users_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "uneet_enterprise_users" );
